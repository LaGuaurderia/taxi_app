...
class _PantallaAutenticacionState extends State<PantallaAutenticacion> {
  ...
  Future<void> _cargarCodigoTaxiGuardado() async {
    try {
      ...
      print('Error cargando código de taxi: $e');
    }
  }
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _esModoLogin ? 'Iniciar Sesión' : 'Registro de Taxista',
  ...
  Widget _buildFormulario() {
    return Column(
      children: [
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () {
                    setState(() {
                      _esModoLogin = false;
                      _codigoTaxiSeleccionado = null; // Limpiar selección en registro
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: !_esModoLogin ? const Color(0xFFa28c7d) : Colors.transparent,
                    ...
                    child: Text(
                      ...
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: !_esModoLogin ? Colors.white : const Color(0xFF584130),
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () async {
                    ...
                    // Cargar código de taxi guardado cuando cambie a login
                    await _cargarCodigoTaxiGuardado();
                  },
                  child: Container(
                    padding: const EdgeInsets.symmetric(vertical: 12),
                    decoration: BoxDecoration(
        ...
        if (!_esModoLogin) ...[
          // Código de taxi (solo en registro)
          const Text(
            'Código de taxi',
            style: TextStyle(
              fontSize: 16,
          ...
          DropdownButtonFormField<String>(
            ...
            onChanged: (String? newValue) {
              print('Dropdown cambiado a: $newValue'); // Debug
              setState(() {
          ...
          DropdownButtonFormField<String>(
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                return 'Por favor selecciona tu código de taxi';
              }
              return null;
            },
            isExpanded: true,
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed: _estaCargando ? null : (_esModoLogin ? _iniciarSesion : _registrarTaxista),
            ...
            child: _estaCargando
                ...
                : Text(
                    _esModoLogin ? 'Iniciar Sesión' : 'Registrarse',
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                    ),
